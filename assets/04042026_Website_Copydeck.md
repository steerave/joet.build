# Website Copy Deck — April 4, 2026
## Sarun (Joe) Teeravechyan Portfolio Site
### Live at: https://professional-website-navy-iota.vercel.app/

This document reflects all approved copy currently live on the site.

---

## NAV

- Logo: Sarun (Joe) Teeravechyan
- Links: Work, About, Connect
...
### Execution at Scale
I lead complex digital programs across product, engineering, and operations — delivering under real-world constraints.

### Systems Thinking
I design workflows and systems that improve clarity, reduce friction, and scale execution.

### AI Application
I build and experiment with AI tools to enhance decision-making and operational efficiency.

---

## SELECTED WORK (Case Studies Overview)
...
### Overview
De-identified case studies representing large-scale digital execution across national North American programs. These examples highlight execution under complexity, transformation through technology, and real-time operational leadership.

---

## CASE STUDY 1 — Scaling a National Digital Promotion with First-Time Ticketless Architecture
...
## CASE STUDY 2 — Transforming Prize Fulfillment from Manual Checks to Real-Time Digital Payouts
...
## CASE STUDY 3 — Scaling a Live Promotion Under Extreme Demand and Fraud Pressure
...
- Navigating constraints through structured systems and risk management
- Applying real-time decision-making to maintain stability and performance

These experiences now inform a broader focus on applying AI to further enhance execution, automation, and operational intelligence.
...
**What it does**
Automates job discovery, filtering, and tracking using AI workflows.
...
**Why it matters**
Demonstrates how AI can enhance decision-making and reduce manual effort.

### AI-Powered Task Manager

**What it does**
A CLI task manager that bridges the terminal and Obsidian, using natural language parsing to capture, organize, and review tasks without friction.
...
**Why it matters**
Shows how thoughtful system design can eliminate friction between task capture and task review.
...
### Buttons
- LinkedIn → https://www.linkedin.com/in/sarun-teeravechyan/
- Email → steerave@gmail.com
